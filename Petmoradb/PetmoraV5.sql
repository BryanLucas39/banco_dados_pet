...
-- Tabela de Pagamento foi colocada em comentário, pois após discussão, 
-- foi decidido que a tabela de pagamento não seria necessária.
...
-- (Criaçao de relacionamentos da tabela agendamento)
...
ALTER TABLE agendamento 
ADD CONSTRAINT `fk_agendamento_pk_pet`
FOREIGN KEY (`ID_Pet`)
REFERENCES pet (`ID_Pet`);

ALTER TABLE  agendamento
ADD CONSTRAINT `fk_agendamento_pk_endereco`
